...
export default function Header({
    ...
    return(
        <div className="">
            <div className="flex justify-center items-center cursor-pointer header-name-wrapper">
                <i 
                    alt="Typeform"
                    >
